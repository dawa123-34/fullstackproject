...
const ServicesTable = () => {
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/services/service`);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/services/service/${id}`);
